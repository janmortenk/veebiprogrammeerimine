  ...
  if(isset($_POST["submitUserData"])){
    ...
    if(!empty($birthDay)and !empty($birthMonth) and !empty($birthYear)){
        if(checkdate($birthMonth, $birthDay, $birthYear)){
            ...
            $birthDateError = "Kahjuks valitud kuupäev pole olemas!";
        }//if checkdate
    ...
    //parooli kontroll, (kas on olemas, kas vähemalt 8 tähte ja kaks korda ühte moodi sisestatud)
